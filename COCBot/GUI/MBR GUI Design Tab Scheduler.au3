...
;~ Scheduler Tab
;~ -------------------------------------------------------------
$tabScheduler = GUICtrlCreateTabItem(GetTranslated(26,1, "Sched"))
Local $x = 30, $y = 150
...
Local $x = 265, $y = 150
	...
	$y += 13
	$x -= 5
	$lbDonateWeekdays1 = GUICtrlCreateLabel(" S", $x + 30, $y)
	GUICtrlSetTip(-1, GetTranslated(26,29, "Sunday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbDonateWeekdays2 = GUICtrlCreateLabel(" M", $x + 45, $y)
	GUICtrlSetTip(-1, GetTranslated(26,30, "Monday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbDonateWeekdays3 = GUICtrlCreateLabel(" T", $x + 60, $y)
	GUICtrlSetTip(-1, GetTranslated(26,31, "Tuesday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbDonateWeekdays4 = GUICtrlCreateLabel(" W", $x + 75, $y)
	GUICtrlSetTip(-1, GetTranslated(26,32, "Wednesday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbDonateWeekdays5 = GUICtrlCreateLabel(" T", $x + 90, $y)
	GUICtrlSetTip(-1, GetTranslated(26,33, "Thursday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbDonateWeekdays6 = GUICtrlCreateLabel(" F", $x + 105, $y)
	GUICtrlSetTip(-1, GetTranslated(26,34, "Friday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbDonateWeekdays7 = GUICtrlCreateLabel(" S", $x + 120, $y)
	...
	GUICtrlSetTip(-1, GetTranslated(26,29, "Sunday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbRequestCCWeekdays2 = GUICtrlCreateLabel(" M", $x + 45, $y)
	GUICtrlSetTip(-1, GetTranslated(26,30, "Monday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbRequestCCWeekdays3 = GUICtrlCreateLabel(" T", $x + 60, $y)
	GUICtrlSetTip(-1, GetTranslated(26,31, "Tuesday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbRequestCCWeekdays4 = GUICtrlCreateLabel(" W", $x + 75, $y)
	GUICtrlSetTip(-1, GetTranslated(26,32, "Wednesday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbRequestCCWeekdays5 = GUICtrlCreateLabel(" T", $x + 90, $y)
	GUICtrlSetTip(-1, GetTranslated(26,33, "Thursday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbRequestCCWeekdays6 = GUICtrlCreateLabel(" F", $x + 105, $y)
	GUICtrlSetTip(-1, GetTranslated(26,34, "Friday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$lbRequestCCWeekdays7 = GUICtrlCreateLabel(" S", $x + 120, $y)
	GUICtrlSetTip(-1, GetTranslated(26,35, "Saturday"))
	GUICtrlSetState(-1, $GUI_DISABLE)
	$y += 13
